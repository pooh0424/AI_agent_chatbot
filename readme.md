...
問題：組員之間啟動專案方式不同
解法：撰寫 README.md 檔，快速讓協作夥伴了解專案執行方式及架構。
...
林楷祐：學習 Git 讓我明白，版本控制不只是存檔，更是對開發狀態的精確管理。透過 .gitignore 排除 node_modules 並保護 .env 敏感資訊，確保了開發環境的純粹與安全；同時，這也讓我更深刻理解團隊協作的規範與流程，是工程師邁向專業開發不可或缺的基礎。
